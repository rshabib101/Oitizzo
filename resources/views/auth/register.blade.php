            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                        <label class="col-md-4 col-form-label text-md-right" for="category">Select District</label>
                            <select class="col-md-6" name="district_id" id="category" class="form-control">
